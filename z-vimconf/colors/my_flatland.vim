...
hi ColorColumn ctermfg=NONE ctermbg=89 cterm=NONE guifg=NONE guibg=#3b3e40 gui=NONE
...
hi StatusLine ctermfg=254 ctermbg=241 cterm=bold guifg=#f8f8f8 guibg=#636567 gui=bold
hi StatusLineNC ctermfg=254 ctermbg=241 cterm=NONE guifg=#f8f8f8 guibg=#636567 gui=NONE
...
hi IncSearch ctermfg=16 ctermbg=254 cterm=NONE guifg=#26292c guibg=#f6f6f6 gui=NONE
...
hi Normal ctermfg=254 ctermbg=234 cterm=NONE guifg=#e4e4e4 guibg=#26292c gui=NONE
...
hi DiffAdd ctermfg=254 ctermbg=64 cterm=bold guifg=#f8f8f8 guibg=#46830e gui=bold
hi DiffDelete ctermfg=88 ctermbg=NONE cterm=NONE guifg=#8b0809 guibg=NONE gui=NONE
hi DiffChange ctermfg=254 ctermbg=23 cterm=NONE guifg=#f8f8f8 guibg=#233a5a gui=NONE
hi DiffText ctermfg=254 ctermbg=24 cterm=bold guifg=#f8f8f8 guibg=#204a87 gui=bold
hi ErrorMsg ctermfg=254 ctermbg=124 cterm=NONE guifg=#f8f8f8 guibg=#aa2915 gui=NONE
hi WarningMsg ctermfg=254 ctermbg=124 cterm=NONE guifg=#f8f8f8 guibg=#aa2915 gui=NONE
...
hi Label ctermfg=254 ctermbg=NONE cterm=NONE guifg=#f6f6f6 guibg=NONE gui=NONE
hi NonText ctermfg=239 ctermbg=NONE cterm=NONE guifg=#7a8288 guibg=#313336 gui=NONE
hi Number ctermfg=149 ctermbg=NONE cterm=NONE guifg=#b8d977 guibg=NONE gui=NONE
...
hi Special ctermfg=254 ctermbg=NONE cterm=NONE guifg=#f8f8f8 guibg=NONE gui=NONE
...
hi String ctermfg=153 ctermbg=NONE cterm=NONE guifg=#f6f6f6 guibg=NONE gui=NONE
hi Tag ctermfg=74 ctermbg=NONE cterm=NONE guifg=#72aaca guibg=NONE gui=NONE
hi Title ctermfg=254 ctermbg=NONE cterm=bold guifg=#f8f8f8 guibg=NONE gui=bold
...
hi rubyStringDelimiter ctermfg=254 ctermbg=NONE cterm=NONE guifg=#f6f6f6 guibg=NONE gui=NONE
...
hi htmlTag ctermfg=149 ctermbg=NONE cterm=NONE guifg=#b7d877 guibg=NONE gui=NONE
hi htmlEndTag ctermfg=149 ctermbg=NONE cterm=NONE guifg=#b7d877 guibg=NONE gui=NONE
hi htmlTagName ctermfg=149 ctermbg=NONE cterm=NONE guifg=#b7d877 guibg=NONE gui=NONE
hi htmlArg ctermfg=149 ctermbg=NONE cterm=NONE guifg=#b7d877 guibg=NONE gui=NONE
